...
public enum MessageType {
    ...
    ACTIVATE_PRODUCTIONS,SHOW_PRODUCTIONS,CHOOSE_PRODUCTIONS,SHOW_CHOSEN_PRODUCTIONS,ASK_ANY_RESOURCE,CHOOSE_ANY_RESOURCE,UPDATE_RESOURCES,
    ...
    SHOW_MARKET,CHOOSE_ROW_OR_COLUMN, UPDATE_MARKET,ASK_DISCARD_RESOURCE,DISCARD_RESOURCE,ASK_CONVERT_RESOURCE,CONVERT_RESOURCE,RESOURCE_DISCARDED,
    VATICAN_REPORT_RESULTS,
    LAST_TURNS,WINNER,
    LORENZO_DISCARD,LORENZO_INCREMENT_FAITH_TRACK, LORENZO_SHUFFLE, LORENZO_WON;
}
